(function ($) {
	...
	/* Portfolio
    -------------------------------------------------------*/
	var $activities_container = $('.activities-grid');
	$activities_container.imagesLoaded(function () {
		$activities_container.isotope({
...
$(document).ready(function () {
	...
	$('.img-activities').click(function () {
		modal.style.display = "block";
		modalImg.src = $(this).attr('src');
		captionText.innerHTML = "Title: " + $(this).attr('alt');
	});
