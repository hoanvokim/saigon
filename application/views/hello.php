...
<!-- Testimonials -->
<section class="section-wrap parallax-testimonials" style="background-image: url(<?php echo base_url() ?>assets/img/testimonials_bg.jpg)">
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						...
						<p class="testimonial-text">I’am amazed, I should say thank you so much for your awesome
							...
							amazing and talented! I will work only with enigma agency.</p>
